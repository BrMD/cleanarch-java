...
public class CreateUserUseCaseImpl implements CreateUserUseCase{
    ...
    public CreateUserUseCaseImpl(CreateUserGateway createUserGateway, EmailAvailableUseCase emailAvailableUseCase, TaxNumberAvailableUseCase taxNumberAvailableUseCase) {
